...
class Util
{
	...
	static public function getColorById($id) {
		$trueColors = array('#F0FFFF','#000000','#0000FF','#8A2BE2','#A52A2A','#5F9EA0','#D2691E','#FF7F50','#6495ED','#DC143C','#00FFFF','#00008B','#008B8B','#B8860B','#A9A9A9','#006400','#8B008B','#556B2F','#FF8C00','#9932CC','#8B0000','#E9967A','#8FBC8F','#483D8B','#2F4F4F','#00CED1','#9400D4','#FF1493','#00BFFF','#696969','#1E90FF','#B22222','#228B22');
